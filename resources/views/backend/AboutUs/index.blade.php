                             ...
                             <?php $count++ ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- <a class="btn btn-danger btn-sm" href="{{ url('tax.edit', $data->id) }}"><i class="fa fa-trash" ></i></a> --}}
                                        {{-- <a data-toggle="modal" onclick="deleteRecord({{ $data->id }})" class="btn btn-danger btn-sm text-white"><i class="fa fa-trash"></i></a> --}}
