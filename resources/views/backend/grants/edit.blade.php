...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i>Add Grants</h1>
            </div>
        ...
        <div class="">
            <a class="btn btn-primary" href="{{ url('grants') }}"><i class="fa fa-edit"></i> Manage Grants</a>
        </div>
        <div class="row mt-2">
            ...
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Add New Grants</h3>
                    <div class="tile-body">
